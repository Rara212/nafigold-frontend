...
export default function Keunggulan() {
    return (
        <div className="bg-white h-50px w-317px py-10 px-80">
            ...
            <p className="text-[#959595]">EOA GOLD bukan hanya berbicara bisnis emas namun lebih jauh dari itu kami berkonsentrasi <br /> 
            kepada pemberdayaan masyarakat agar kuat secara ekonomi secara berjamaah.</p>
